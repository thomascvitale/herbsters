...
#if defined(NDEBUG)
# error "herbsters cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "herbsters Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s HRS additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("herbsters-scriptch");
