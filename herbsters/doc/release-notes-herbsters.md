...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 herbs per kB (0.00001 HRS). This is to prepare for dropping the minimum transaction fee to 0.1 herbs per kB (0.0001 HRS) in the next release.
