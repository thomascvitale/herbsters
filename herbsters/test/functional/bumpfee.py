...
from test_framework.test_framework import herbstersTestFramework, SkipTest
...
class BumpFeeTest(herbstersTestFramework):
    ...
    def run_test(self):
        raise SkipTest("herbsters doesn't support RBF.")
        ...
        # fund rbf node with 10 coins of 0.1 hrs (10,000,000 satoshis)
